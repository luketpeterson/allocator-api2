//! *--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--
//! This implementation was cribbed from Rust 1.84.0
//! *--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--*--==--
//!
...
//QUESTION: Not sure what to do here... Assuming `not(sanitize)` is the default
...
impl<T> Arc<T> {
    ...
    #[cfg(not(no_global_oom_handling))]
    #[inline]
    //TODO, requires bumping the min Rust version of this crate, so disabling this API
    #[cfg(any())]
...
//TODO, Specialization is unstable
#[cfg(any())]
#[cfg(not(no_global_oom_handling))]
...
//TODO: Should mirror CloneToUninit inside this crate, because this is a very useful feature!
#[cfg(any())]
#[cfg(not(no_global_oom_handling))]
...
//TODO, This crate might need its own copy of Cow
#[cfg(any())]
